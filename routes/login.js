...
async function getUserByEmail(email) {
    const result = await client.queryArray(
        `SELECT user_id, username, password_hash FROM xyz789_users WHERE username = $1`, //HOX!! Laita tähän menemää omaa tauluun!! Minun käyttäjät näkyvät taulussa xyz789_users.
        [email]
    );
